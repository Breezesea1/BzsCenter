...
namespace BzsCenter.Idp.UnitTests.Services.Admin;
...
public sealed class AdminDashboardServiceTests
{
    ...
    private static BzsCenter.Idp.Models.BzsUser CreateUser(Guid id, string userName, string email)
    {
        return new BzsCenter.Idp.Models.BzsUser
        {
            Id = id,
            UserName = userName,
            Email = email

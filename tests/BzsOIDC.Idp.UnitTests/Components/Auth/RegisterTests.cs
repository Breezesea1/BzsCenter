...
public sealed class RegisterTests
{
    ...
    public void RegisterCss_MatchesLoginCssExactly()
    {
        ...
        var loginCssPath = Path.Combine(solutionRoot, "src", "BzsOIDC.Idp", "Components", "Auth", "Pages", "Account", "Login.razor.css");
        var registerCssPath = Path.Combine(solutionRoot, "src", "BzsOIDC.Idp", "Components", "Auth", "Pages", "Account", "Register.razor.css");
    ...
    private static string FindSolutionRoot()
    {
        ...
        {
            var solutionPath = Path.Combine(directory.FullName, "BzsOIDC.sln");
        ...
        throw new InvalidOperationException("Could not locate BzsOIDC.sln from the test output directory.");
    }
